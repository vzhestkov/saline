...
from salt.utils.parsers import MasterOptionParser, SaltCMDOptionParser, OptionParserMeta
...
class SalineCMDOptionParser(
    SaltCMDOptionParser, metaclass=OptionParserMeta
):  # pylint: disable=no-init

    description = "The Saline command line tool"
    epilog = ""

    # ConfigDirMixIn config filename attribute
    _config_filename_ = "salinecmd"
    # LogLevelMixIn attributes
